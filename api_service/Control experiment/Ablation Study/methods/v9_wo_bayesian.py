...
# -*- coding: utf-8 -*-
"""
V9 w/o Bayesian Optimization: V9方法移除贝叶斯优化模块
保留: Prioritized DQN + Meta-Learning + NAS
"""
import logging
import sys
import os
...
def run_v9_wo_bayesian(model_path: str = None) -> Dict[str, float]:
    """运行V9方法（移除贝叶斯优化）
    ...
    logging.info("[Ablation-V9-w/o-Bayesian] 初始化V9方法（移除贝叶斯优化）...")
    logging.info(f"[Ablation-V9-w/o-Bayesian] 使用模型: {model_path}")
    ...
    # 创建Agent（禁用贝叶斯优化）
    logging.info("🧩 创建V9 Agent（enable_bayesian_opt=False）...")
