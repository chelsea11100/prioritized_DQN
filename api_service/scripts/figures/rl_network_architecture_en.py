...
# 添加标题
title = ax.text(5, 11.5, 'Prioritized DQN Network Architecture\nfor Microservice Kernel Parameter Optimization', 
...
━━━━━━━━━━━━━━━━━━━━
• Convergence: 75 episodes
• Avg Reward: 0.328
• QPS Performance: 150.8
• Memory Usage: 1.5GB
...
legend_elements = [
    ...
    plt.Rectangle((0,0),1,1, facecolor=colors['hidden'], label='Hidden Layers'),
    plt.Rectangle((0,0),1,1, facecolor=colors['output'], label='Output Layer'),
    plt.Line2D([0],[0], color=colors['connection'], label='Network Connections')
]
...
# 保存图片
plt.savefig('rl_network_architecture_en.png', dpi=300, bbox_inches='tight', 
            facecolor='white', edgecolor='none')

# 显示图片
plt.show()

print("Reinforcement Learning Network Architecture diagram has been generated and saved as 'rl_network_architecture_en.png'")
